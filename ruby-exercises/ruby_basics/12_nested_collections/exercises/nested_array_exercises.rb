...
def delete_seat_from_row(chart, row_index, seat_index)
  ...
  chart[row_index] = chart[row_index].select.with_index do |row, index|
    index != seat_index
  end
  chart
end
...
def delete_row_from_chart(chart, row_index)
  ...
  # then return the chart
  chart = chart.select.with_index do |row, index|
    row_index != index
  end
  chart
end
...
def find_favorite(array_of_hash_objects)
  ...
  favorite = array_of_hash_objects.select do |object| 
    object[:is_my_favorite?] == true
  end
